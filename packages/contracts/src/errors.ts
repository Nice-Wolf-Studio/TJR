 ...
 * ```
 */
export class TJRError extends Error {
  /**
 ...
 * ```
 */
export class ProviderRateLimitError extends TJRError {
  /**
 ...
 * ```
 */
export class InsufficientBarsError extends TJRError {
  /**
 ...
 * ```
 */
export class SymbolResolutionError extends TJRError {
  /**
 ...
 * ```
 */
export function isTJRError(error: unknown): error is TJRError {
 ...
 */
export function isInsufficientBarsError(error: unknown): error is InsufficientBarsError {
 ...
 */
export function isSymbolResolutionError(error: unknown): error is SymbolResolutionError {
