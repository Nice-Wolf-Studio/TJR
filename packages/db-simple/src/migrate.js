...
function readMigrationFiles(migrationsDir) {
    ...
    try {
        ...
        throw new Error(`Failed to read migrations directory: ${migrationsDir}. Error: ${error instanceof Error ? error.message : String(error)}`);
    }
    ...
    return sqlFiles.map((file) => {
        ...
        try {
            ...
            throw new Error(`Failed to read migration file: ${file}. Error: ${error instanceof Error ? error.message : String(error)}`);
        }
    });
}
/**
